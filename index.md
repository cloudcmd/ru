...
Результат настройки файлогово менеджера записывается в текстовый файл доступный для чтения и редактирования. Он называется `~/.cloudcmd.json` и содержит следующие поля:
