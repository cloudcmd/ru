...
### Возможности
- Синтаксическая подсветка в зависимости от типа файла, для более чем 110 языков.
- Встроенный `emmet` (для html файлов)
- Drag n drop (перетащите файл с рабочего стола в редактор).
...
- Настраиваемые опции (можно изменить в `json/edit.json`)
...
Их можна поменять собственно ручно в любом текстовом редакторе.
Вот описание опций:
