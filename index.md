...
Настройки будут читаться с домашнего каталога, корень файловой системы монтирован к `/mnt/fs`,
`8000` порт контейнера будет доступен через порт хостовой системы.
